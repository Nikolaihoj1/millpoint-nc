...
import { setupSheets } from '../data/mockData';
import { 
  Camera, 
  Image, 
  CheckSquare, 
...
export function SetupSheetPreview({ programId, onBack }: SetupSheetPreviewProps) {
  const setupSheet = setupSheets.find(s => s.programId === programId);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              {setupSheet.approvedBy && <Badge variant="success">Godkendt</Badge>}
            </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="font-medium text-lg">{setupSheet.machineType}</p>
              </div>
              
              {setupSheet.fixtures.map((fixture, idx) => (
          ...
          <Card>
            ...
            <CardContent>
              {setupSheet.originOffsets.map((offset, idx) => (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Opsætningsfotos & Videoer (5 påkrævet)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {setupSheet.media.map((item, idx) => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                {setupSheet.safetyChecklist.map((item, index) => (
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-medium">{setupSheet.createdAt}</p>
              </div>
              <div>
                <label className="text-muted-foreground">Oprettet Af</label>
                <p className="font-medium">{setupSheet.createdBy}</p>
              </div>
              {setupSheet.approvedBy && (
                <>
                  <div>
                    <label className="text-muted-foreground">Godkendt Af</label>
                    <p className="font-medium">{setupSheet.approvedBy}</p>
                  </div>
                  <div>
                    <label className="text-muted-foreground">Godkendt</label>
                    <p className="font-medium">{setupSheet.approvedAt}</p>
                  </div>
                </>
              )}
            </CardContent>
